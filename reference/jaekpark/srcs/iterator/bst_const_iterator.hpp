#ifndef _FT_CONST_BST_ITERATOR_HPP
#define _FT_CONST_BST_ITERATOR_HPP
...
template <class T>
class bst_const_iterator : public ft::iterator<bidirectional_iterator_tag, T> {
 private:
 ...
 public:
  ...
  bst_const_iterator(T* x) : _i(x) {}
  // copy_constructor
  bst_const_iterator(const bst_const_iterator& x) { this->_i = x._base(); }
  // destructor
  ~bst_const_iterator(void) {}
  // operator=
  bst_const_iterator& operator=(const bst_const_iterator& x) {
    _i = x._base();
    return *this;
  };
 ...
 public:
  ...
  bool operator==(const bst_const_iterator& x) { return this->_i == x._base(); }
  bool operator!=(const bst_const_iterator& x) {
    return !(this->_i == x._base());
  }
};
